...
brew install joplin                                               # Open source note taking and to-do application on the Terminal (https://github.com/laurent22/joplin)
...
brew cask install joplin                                          # Open source note taking and to-do application on the Desktop (https://github.com/laurent22/joplin)
