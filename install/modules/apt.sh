...
sudo apt install postgresql                                                                         # PostgreSQL is an advanced object-relational database management system (https://github.com/postgres/postgres)
sudo apt install postgresql-contrib                                                                 # PostgreSQL is an advanced object-relational database management system (https://github.com/postgres/postgres)
