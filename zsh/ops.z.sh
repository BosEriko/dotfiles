...
alias i-fucked-up='(cd /Users/boseriko/development/OpsManager && pg_restore --verbose --dbname=airdrilling_development --clean --no-acl --no-owner --host=localhost "tmp/opsmanager-production-backup.dump")'
